...
<head>
    ...
    <title>Invoice Kadaluarsa — Vanilla Royal</title>
...
<div style="width:100%; max-width:420px;">
    ...
    <div style="background:#fff; border-radius:20px; overflow:hidden; box-shadow:0 12px 40px rgba(44,24,16,0.22);">
        ...
        <div style="padding:2.25rem 2rem 1.5rem; text-align:center; border-bottom:1px solid #f3ede4;">
            <div style="width:64px; height:64px; border-radius:50%; background:#fffbeb; border:2px solid #fde68a; display:flex; align-items:center; justify-content:center; margin:0 auto 1.25rem;">
            ...
            <h1 style="font-size:1.25rem; font-weight:700; color:#92400e; margin-bottom:0.35rem;">Invoice Kadaluarsa</h1>
        ...
        <div style="padding:1.5rem 2rem;">
            <div style="background:#fef9f0; border-radius:12px; padding:1rem 1.25rem; margin-bottom:1.5rem;">
                <table style="width:100%; border-collapse:collapse; font-size:0.85rem;">
                    ...
                    @if($invoice->due_date)
                    <tr>
                        <td style="padding:0.4rem 0; color:#9ca3af;">Jatuh Tempo</td>
                        <td style="padding:0.4rem 0; color:#dc2626; font-weight:600; text-align:right;">{{ $invoice->due_date->format('d M Y') }}</td>
                    </tr>
                    @endif
                </table>
            </div>
            <p style="font-size:0.82rem; color:#9ca3af; text-align:center; line-height:1.65;">
                Invoice telah melewati jatuh tempo.<br>
                Hubungi <strong style="color:#41281b;">Vanilla Royal</strong> untuk membuat invoice baru.
            </p>
        </div>

        <div style="padding:1rem 2rem; background:#fafafa; border-top:1px solid #f3ede4; text-align:center;">
            <p style="font-size:0.7rem; color:#d1c4b8; letter-spacing:0.05em; text-transform:uppercase;">Masa berlaku invoice telah habis</p>
        </div>
    </div>
